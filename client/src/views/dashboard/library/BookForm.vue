<template>
  <div class="p-6">
    ...
    <div class="flex items-center gap-4 mb-8">
      <router-link to="/dashboard/library" class="p-2 bg-white dark:bg-green-900/40 border border-green-200 dark:border-green-800 rounded-lg text-green-600 dark:text-gray-400 hover:text-brand-orange dark:hover:text-brand-orange transition-colors">
        <PhArrowLeft :size="20" />
      </router-link>
      <div>
        ...
        <p class="text-green-500 dark:text-gray-400 mt-1">Kelola katalog pustaka digital</p>>
      </div>
    </div>
    ...
    <form @submit.prevent="saveBook" class="max-w-4xl">
      <div class="bg-white dark:bg-green-900/40 rounded-lg p-6 border border-green-200 dark:border-green-800 mb-6 transition-colors">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div class="md:col-span-2">
            <label class="block text-sm font-bold text-green-700 dark:text-gray-300 mb-2">Judul Buku</label>>
            <input
              v-model="form.title"
              type="text"
              required
          ...
          <div>
            <label class="block text-sm font-bold text-green-700 dark:text-gray-300 mb-2">Penulis</label>>
            <div class="relative">
               <PhUser :size="18" class="absolute left-4 top-3.5 text-green-400" />
               <input
                v-model="form.author"
                type="text"
                required
          ...
          <div class="md:col-span-2">
            <label class="block text-sm font-bold text-green-700 dark:text-gray-300 mb-2">Ringkasan</label>>
            <textarea
      ...
      <!-- Style Customization -->
      <div class="bg-white dark:bg-green-900/40 rounded-lg p-6 border border-green-200 dark:border-green-800 mb-6 transition-colors">
        <h2 class="text-lg font-bold text-text-green dark:text-gray-400 mb-2 flex items-center gap-2">
          <PhPalette :size="20" />
          Kustomisasi Tampilan Halaman
        </h2>
        <p class="text-sm text-green-500 dark:text-gray-400 mb-6">Atur warna dan font khusus untuk halaman detail buku ini agar sesuai dengan mood buku.</p>>
        
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div class="p-4 bg-cream-100 dark:bg-green-900/60 rounded-lg border border-green-100 dark:border-green-800">
            <label class="block text-sm font-bold text-green-700 dark:text-gray-300 mb-2">Background Color</label>>
            <div class="flex items-center gap-3">
              ...
              />
              <span class="text-sm font-mono text-green-600 dark:text-gray-400 border border-green-200 dark:border-green-700 px-2 py-1 rounded bg-white dark:bg-green-950">{{ form.styleConfig.bgColor }}</span>
            </div>
          </div>

          <div class="p-4 bg-cream-100 dark:bg-green-900/60 rounded-lg border border-green-100 dark:border-green-800">
            <label class="block text-sm font-bold text-green-700 dark:text-gray-300 mb-2">Accent Color</label>>
            <div class="flex items-center gap-3">
              <input
                ...
                class="w-10 h-10 rounded cursor-pointer border-0 p-0"
              />
              <span class="text-sm font-mono text-green-600 dark:text-gray-400 border border-green-200 dark:border-green-700 px-2 py-1 rounded bg-white dark:bg-green-950">{{ form.styleConfig.accentColor }}</span>
            </div>
          </div>

          <div class="p-4 bg-cream-100 dark:bg-green-900/60 rounded-lg border border-green-100 dark:border-green-800">
            <label class="block text-sm font-bold text-green-700 dark:text-gray-300 mb-2">Font Judul</label>>
            <div class="relative">
              <PhTextT :size="18" class="absolute left-3 top-3.5 text-green-400" />
              <select
