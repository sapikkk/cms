<template>
  <div class="p-6">
    ...
    <div class="flex items-center gap-4 mb-8">
      <router-link to="/dashboard/funfacts" class="p-2 bg-white dark:bg-green-900/40 border border-green-200 dark:border-green-800 rounded-lg text-green-600 dark:text-gray-400 hover:text-brand-orange transition-colors">
        <PhArrowLeft :size="20" />
      </router-link>
      <div>
        <h1 class="text-3xl font-bold text-text-green dark:text-white">{{ isEdit ? 'Edit Fun Fact' : 'Buat Fun Fact Baru' }}</h1>
        <p class="text-green-500 dark:text-gray-400 mt-1">Bagikan trivia dan fakta menarik</p>
      </div>
    </div>
      ...
      <div class="bg-white dark:bg-green-900/40 rounded-lg p-6 border border-green-200 dark:border-green-800 mb-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
           ...
           <div class="md:col-span-2">
            <label class="block text-sm font-bold text-green-700 dark:text-gray-300 mb-2">Konten</label>
            <textarea
          ...
          <div class="md:col-span-2">
            <div class="flex items-center gap-4">
              ...
              />
              <label for="isPublished" class="text-green-700 dark:text-gray-300 font-medium">Publish Fun Fact</label>
            </div>
          </div>
        </div>
      </div>
