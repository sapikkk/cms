<template>
  <div class="p-6">
    ...
    <div class="flex items-center gap-4 mb-8">
      <router-link to="/dashboard/events" class="p-2 bg-white dark:bg-green-900/40 border border-green-200 dark:border-green-800 rounded-lg text-green-600 dark:text-gray-400 hover:text-brand-orange transition-colors">
        <PhArrowLeft :size="20" />
      </router-link>
      <div>
        ...
        <p class="text-green-500 dark:text-gray-400 mt-1">Lengkapi informasi event atau workshop</p>
      </div>
    </div>
    ...
    <form @submit.prevent="saveEvent" class="max-w-4xl">
      ...
      <div class="bg-white dark:bg-green-900/40 rounded-lg p-6 border border-green-200 dark:border-green-800 mb-6">
        <h2 class="text-lg font-bold text-text-green dark:text-white mb-6 flex items-center gap-2">
          <PhInfo :size="20" />
          Informasi Dasar
        </h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div class="md:col-span-2">
            <label class="block text-sm font-bold text-green-700 dark:text-gray-300 mb-2">Judul Event</label>
            <input
              v-model="form.title"
              type="text"
              required
          ...
          <div>
            <label class="block text-sm font-bold text-green-700 dark:text-gray-300 mb-2">Tanggal & Waktu</label>
            <input
          ...
          <div>
            <label class="block text-sm font-bold text-green-700 dark:text-gray-300 mb-2">Lokasi</label>
            <input
          ...
          <div>
            <label class="block text-sm font-bold text-green-700 dark:text-gray-300 mb-2">Maksimal Peserta</label>
            <input
          ...
          <div>
            <label class="block text-sm font-bold text-green-700 dark:text-gray-300 mb-2">Deadline Pendaftaran</label>
            <input
      ...
      <!-- Pricing -->
      <div class="bg-white dark:bg-green-900/40 rounded-lg p-6 border border-green-200 dark:border-green-800 mb-6">
        <h2 class="text-lg font-bold text-text-green dark:text-white mb-6">Harga</h2>
        ...
        <div class="flex items-center gap-4 mb-4">
          ...
          />
          <label for="isFree" class="text-green-700 dark:text-gray-300 font-medium">Event Gratis</label>
        </div>
      ...
      <!-- Publishing -->
      <div class="bg-white dark:bg-green-900/40 rounded-lg p-6 border border-green-200 dark:border-green-800 mb-6">
        <h2 class="text-lg font-bold text-text-green dark:text-white mb-6">Publikasi</h2>
        ...
        <div class="space-y-4">
          <div class="flex items-center gap-4">
            <input
              ...
              class="w-5 h-5 text-brand-orange focus:ring-brand-orange rounded"
            />
            <label for="isPublished" class="text-green-700 dark:text-gray-300 font-medium">Publish Event</label>
          </div>
          ...
          <div class="flex items-center gap-4">
            <input
              ...
              class="w-5 h-5 text-brand-orange focus:ring-brand-orange rounded"
            />
            <label for="isFeatured" class="text-green-700 dark:text-gray-300 font-medium">Tampilkan di Homepage</label>
          </div>
        </div>
      </div>
...
const saveEvent = async () => {
  ...
  try {
    ...
    form.slug = form.title.toLowerCase().replace(/\s+/g, '-').replace(/[^\w\-]/g, '')
